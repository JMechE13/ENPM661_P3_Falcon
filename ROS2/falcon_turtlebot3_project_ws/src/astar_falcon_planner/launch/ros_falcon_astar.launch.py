...
def generate_launch_description():
    ...
    start_position_launch_arg = DeclareLaunchArgument(
        'start_position',
        default_value='[0.3, 0.3, 0.0]'
    )
    end_position_launch_arg = DeclareLaunchArgument(
        'end_position',
        default_value='[4.9, 0.8, 0.0]'
    )
    ...
    launch_falcon_sim = ExecuteProcess(
        cmd=[[
            ' ./Falcon.sh ',
            ' -scenario=/home/jshaheen/UMD-ENPM661-AStar-FalconSim-Assignment/Scenarios/AMRPathPlanning/AMRPathPlanning.usda',
            ]],
        cwd="/home/jshaheen/duality/falconsim-v5.1.0216/",
        shell=True
    )
